...
class LancamentoPolicy
{
    ...
    {
        return $user->can('create_lancamento');
    }
    ...
    {
        return $user->can('update_lancamento');
    }
    ...
    {
        return $user->can('delete_lancamento');
    }
    ...
    {
        return $user->can('delete_any_lancamento');
    }
     ...
     */
    public function replicate(User $user, Lancamento $lancamento): bool
    {
