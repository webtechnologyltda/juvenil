<section class="relative z-10 flex min-h-[100dvh] w-full items-end px-4 pb-[calc(7.5rem+env(safe-area-inset-bottom))] pt-36 sm:px-6 sm:pb-20 sm:pt-44 lg:min-h-[calc(100dvh-7rem)] lg:px-8 lg:pb-20 lg:pt-64">
    <div class="mx-auto w-full max-w-7xl">
        <div class="juvenil-hero-copy flex max-w-xl flex-col text-left">
            ...
            <p class="order-2 mt-5 text-center text-xs font-black uppercase tracking-[0.26em] text-[#9ddbef] sm:text-left sm:text-sm" data-motion-heading>
                Inscrições para campistas de 29 a 59 anos
            </p>
            <p class="juvenil-poster-title order-1 mx-auto w-fit max-w-full text-center text-[2.75rem] uppercase leading-[0.86] text-white drop-shadow-[0_14px_34px_rgba(0,0,0,0.36)] sm:mx-0 sm:w-auto sm:text-left sm:text-[4.6rem] lg:text-[5.4rem]" data-motion-heading>
