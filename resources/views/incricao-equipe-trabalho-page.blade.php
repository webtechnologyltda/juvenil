    ...
    <section
        ...
        <section class="relative  w-full flex flex-wrap justify-center ">
            <header
                ...
                <figure class="w-[60px] lg:w-[80px] h-[60px] lg:h-[80px]"></figure>
            ...
            <div class="w-[700px] md:w-[1000px] container h-auto  ">
                ...
                <div class="mt-8 grid justify-items-center">
                    <a
                        ...
                        <span
                            class="relative text-sm  text-center font-mono uppercase">Increver-se para Trabalhar</span>
                    </a>
                </div>
            </div>
